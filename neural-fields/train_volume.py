...
from core.implicit import implicit_dict
from core.sampler import sampler_dict, StratifiedRaysampler
from core.renderer import renderer_dict
from core.render_functions import render_points
from core.ray_utils import (
    sample_images_at_xy,
...
def render_images(
    ...
    for cam_idx, camera in enumerate(cameras):
        ...
        # print("Sample points shape:", ray_bundle.sample_points.shape)
...
def train(
    ...
    all_images = render_images(
        model, create_surround_cameras(3.0, n_poses=20), image_size, cfg, file_prefix='part_2'
    )
        ...
        if (
            ...
            with torch.no_grad():
                test_images = render_images(
                    ...
                    cfg.data.image_size, cfg, file_prefix='nerf'
                )
                imageio.mimsave('images/' + cfg.data.dataset_name + '.gif', [np.uint8(im * 255) for im in test_images], loop=0)
